...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('dashboard')->middleware('role:superadmin')->group(function () {
       ...
       //import
       Route::get('/products/import', [DashboardController::class, 'showImportForm'])->name('dashboard.import.show');
       Route::post('/products/import', [DashboardController::class, 'import'])->name('dashboard.import');
    });
