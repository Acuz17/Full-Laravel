            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row"> <!-- Add a row for stock and condition -->
                            <div class="col-md-6"> <!-- First column for stock -->
                                <p><strong>Kondisi:</strong> {{ $product->condition }}</p>
                            </div>
                            <div class="col-md-6"> <!-- Second column for condition -->
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <p><strong>Deskripsi:</strong> {{ $product->description }}</p>
                        <a href="{{ route('transactions.showCheckoutForm', ['product_id' => $product->id]) }}" class="btn btn-secondary">Check Out</a>
                        {{-- <a href="{{ route('transactions.index', ['id' => $transaction->id]) }}">Detail Transaksi</a> --}}
