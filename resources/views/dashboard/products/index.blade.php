        ...
        <div class="row bg-info rounded px-3 py-3 w-100">
            <div class="d-flex justify-content-between">
                ...
                <div class="d-flex justify-content-end">
                    <!-- export excel button -->
                    <a href="{{ route('dashboard') }}" class="btn btn-md btn-secondary fw-bold my-auto me-1">lihat profile</a>
                        <a href="{{ route('dashboard.import.show') }}" class="btn btn-md btn-success fw-bold my-auto me-1">Import Produk</a>
                        <a href="{{ route('dashboard.products.export') }}" class="btn btn-md btn-warning fw-bold my-auto me-1">Export
                            produk</a>
